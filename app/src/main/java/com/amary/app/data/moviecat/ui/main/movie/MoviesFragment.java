...
import com.amary.app.data.moviecat.ui.detail.movie.DetailMovieActivity;
import com.amary.app.data.moviecat.ui.favorite.FavoriteActivity;
import com.amary.app.data.moviecat.ui.setting.SettingActivity;
 ...
 */
public class MoviesFragment extends BaseFragment implements MovieView, SearchView.OnQueryTextListener {
    private ArrayList<DisMovieResponse.ResultMovie> itemMovie = new ArrayList<>();
