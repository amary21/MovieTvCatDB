...
class MovieAdapter(private val context: Context, private val grid : Boolean) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private var movieTvCatData: MutableList<MovieTvCatData> = ArrayList()

    fun setMovie(movieTvCatData: List<MovieTvCatData>){
