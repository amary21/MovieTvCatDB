...
public class FavMovieListAdapater extends RecyclerView.Adapter<FavMovieListAdapater.FavoriteViewHolder> {
    ...
    class FavoriteViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(Movie movie) {
            txtJudul.setText(movie.titleMovie);
            txtTglRilis.setText(DateConvert.convert(movie.dateMovie));
            txtRating.setText(movie.rateMovie.toString());
            ImgDownload.imgPoster(movie.posterMovie,imgPoster);
            ImgDownload.imgPoster(movie.backdropsMovie, imgBackdrops);
