...
public class DetailTvActivity extends BaseActivity implements DetailTVView {
    ...
    private ArrayList<GetImageTv.ImageTvItem> imageTvItems = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DisTvResponse.ResultTv resultTv = getIntent().getParcelableExtra(EXTRA_TV);
        Objects.requireNonNull(getSupportActionBar()).setTitle(R.string.tvshow);
        txtTitleTv.setText(Objects.requireNonNull(resultTv).getName());
    ...
    private void addTvFavorite(DisTvResponse.ResultTv resultTv, boolean isAdd) {
