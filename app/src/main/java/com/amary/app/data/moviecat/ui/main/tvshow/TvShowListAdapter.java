...
public class TvShowListAdapter extends RecyclerView.Adapter<TvShowListAdapter.CategoryViewHolder> {
    ...
    private ArrayList<DisTvResponse.ResultTv> tvData;
    private static ClickListener clickListener;

    TvShowListAdapter(ArrayList<DisTvResponse.ResultTv> tvData) {
        this.tvData = tvData;
    }

    void refill(ArrayList<DisTvResponse.ResultTv> tvData){
    ...
    public class CategoryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        @SuppressLint("SetTextI18n")
        void onBind(DisTvResponse.ResultTv resultTv) {
    ...
    void setFilter(ArrayList<DisTvResponse.ResultTv> filter){
        this.tvData = new ArrayList<>();
