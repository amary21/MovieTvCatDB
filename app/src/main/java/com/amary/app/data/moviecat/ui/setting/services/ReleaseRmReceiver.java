package com.amary.app.data.moviecat.ui.setting.services;
...
public class ReleaseRmReceiver extends BroadcastReceiver {
    ...
    private void checkRelease(Context context, ArrayList<DisMovieResponse.ResultMovie> resultMovies, String message){
