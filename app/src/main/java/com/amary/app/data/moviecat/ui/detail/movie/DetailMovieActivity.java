...
public class DetailMovieActivity extends BaseActivity implements DetailMovieView {
    ...
    private ArrayList<GetImageMovie.ImageMovieItem> imageMovieItems = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DisMovieResponse.ResultMovie resultMovie = getIntent().getParcelableExtra(EXTRA_MOVIE);
    ...
    private void addMovieFavorite(DisMovieResponse.ResultMovie resultMovie, boolean isAdd) {
