...
public class MovieListAdapter extends RecyclerView.Adapter<MovieListAdapter.CategoryViewHolder>{
    private ArrayList<DisMovieResponse.ResultMovie> movieData;
    private static ClickListener clickListener;

    MovieListAdapter(ArrayList<DisMovieResponse.ResultMovie> movieData) {
        this.movieData = movieData;
    }

    void refill(ArrayList<DisMovieResponse.ResultMovie> movieData){
    ...
    public class CategoryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        void onBind(DisMovieResponse.ResultMovie resultMovie) {
    ...
    void setFilter(ArrayList<DisMovieResponse.ResultMovie> filter){
        this.movieData = new ArrayList<>();
