...
public class DetailMoviePresenter {
    ...
    void getDetailMovie(int id, String bahasa, final DetailMovieView detailMovieView) {
    ...
    void getImageMovie(int id, String bahasa, final DetailMovieView detailMovieView){
        detailMovieView.showLoading();
