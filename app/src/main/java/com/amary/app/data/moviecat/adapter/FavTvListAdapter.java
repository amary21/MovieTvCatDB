...
public class FavTvListAdapter extends RecyclerView.Adapter<FavTvListAdapter.FavoriteViewHolder> {
    ...
    class FavoriteViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(Tv tv) {
            txtJudul.setText(tv.titleTv);
            txtTglRilis.setText(DateConvert.convert(tv.dateTv));
            txtRating.setText(tv.rateTv.toString());
            ImgDownload.imgPoster(tv.posterTv,imgPoster);
            ImgDownload.imgPoster(tv.backdropsTv, imgBackdrops);
