...
import com.amary.app.data.moviecat.ui.setting.SettingPreference;
...
public class MainActivity extends BaseActivity {
    ...
    private void getCreateActivity(){
        setContentView(layout.activity_main);
        ButterKnife.bind(this);
        setSupportActionBar(toolbar);
        MainTabAdapter adapter = new MainTabAdapter(getSupportFragmentManager(), tabMenu.getTabCount());
